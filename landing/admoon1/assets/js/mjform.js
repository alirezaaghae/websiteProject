...
$.ajax({url:'/assets/js/mjform.php',method:"POST",data:{'ajax':'true','in':'5'+a,'page':page,'field1':field1,'field2':field2,'field3':field3,'field4':field4},success:function(result){elm.find('.mjsubmit').removeClass('pending');elm.addClass('success');}});
});